            ...
            <div class="col-md-6 right-box">
                <div class="row align-items-center ">
                    <form action="../config/testLogin.php" method="POST">
                        ...
                        <div class="input-group mb-3">
                            <button class="btn btn-lg btn-primary w-100 fs-6 inputSubmit" style="background: #21b4b4; border-color:#21b4b4" type="submit" name="submit" value="Enviar">Login</button>
                        </div>
                        <div class="row">
