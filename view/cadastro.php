<?php
include "../includes/include_cadastro.php"
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<body>
    ...
    <div class="container d-flex justify-content-center align-items-center min-vh-100">
        ...
        <div class="row border rounded-5 p-3 bg-white shadow box-area">
            ...
            <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" style="background: #21b4b4;">
            ...
            <div class="col-md-6 right-box">
                <div class="row align-items-center ">
                    <form action="../view/cadastro.php" method="POST">
                        ...
                        <div class="input-group mb-3">
                            <button class="btn btn-lg btn-primary w-100 fs-6 inputSubmit" style="background:#21b4b4; border-color:#21b4b4" type="submit" name="submit" value="Enviar">Cadastre-se</button>
                        </div>
                        <div class="row">
